...
func main() {
	conversationID := "1"
	jwt := "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3NDk1OTEwNTEsImlhdCI6MTc0OTUwNDY1MSwicm9sZSI6ImNyZWF0b3IiLCJzdWIiOjN9.0pzPUi6XGssxRTft9JVI8dZ5ZDxSfMcGhsvNAF1-EKA"
